...
### [SystemLink User Metrics](./User%20Metrics/)
...
**Key Features:**
- Current-headcount stat panels (Casual, Standard, Operator, Collaborator, plus a combined total) with sparklines, alongside a stacked "Users by Month" bar chart, all sourced from the SystemLink Tags data source.
...
- Optional User Metrics CSV Exporter notebook produces pseudonymized per-user history for cross-instance, de-duplicated usage reconciliation.
